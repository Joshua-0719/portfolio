...
type Photo = { title: string; location: string; year: string; category: string; src: string; orientation: "landscape" | "portrait"; aspectRatio: number };

const categories = ["All work", "Places", "Portraits", "Street", "Objects"];
const landscapeFiles = new Set(["6A1665EC-5F51-4F78-B0A0-D3AC79F90289.JPG", "DSCF0098.JPG", "DSCF0264.JPG", "DSCF0287.JPG", "DSCF0353.JPG", "DSCF0789.JPG", "DSCF0796.JPG", "DSCF0820.JPG", "DSCF0968.JPG", "DSCF1006.JPG", "DSCF1026.JPG", "DSCF1265.JPG"]);
const widerPortraitFiles = new Set(["1102F479-CBA1-47D1-85EA-2C9F59C35BC7.JPG", "23E993F3-CD0B-49D0-B135-33CA32C4A4EA.JPG", "49A8DAA1-7B9A-4917-9666-6466E2F24992.JPG", "60205EC6-F06F-415E-9201-72F39C7BEC2A.JPG", "62D8B27E-A5AD-4C49-8645-24AA64363D74.JPG", "865CF3EB-C3BC-4F45-9098-DF419C8F8C7A.JPG", "B37F97DE-88CC-4EF7-8350-9700331C96BE.JPG", "B6C080FC-91FD-472C-B700-08DC90253802.JPG", "C7EB07C3-40F0-4080-9263-342240D2D9BF.JPG", "F89D3E35-B54C-43B8-9E66-62ACFE7961D2.JPG"]);
const photoFiles = [
...
const photos: Photo[] = photoFiles.map((file, index) => ({
  ...
  src: `/pics/${file}`,
  orientation: landscapeFiles.has(file) ? "landscape" : "portrait",
  aspectRatio: landscapeFiles.has(file) ? 1.5 : widerPortraitFiles.has(file) ? 3277 / 4096 : 0.75,
}));
  ...
  return (
    <main>
      <section className="hero" onMouseMove={handleLensMove}>
        ...
        <button className="lens-stage" type="button" style={{ "--lens-x": `${lensPosition.x}%`, "--lens-y": `${lensPosition.y}%` } as React.CSSProperties} onClick={() => document.getElementById("archive")?.scrollIntoView({ behavior: "smooth" })} aria-label="Open the photography archive"><div className="lens-ring ring-outer" /><div className="lens-ring ring-mid" /><div className="lens-scale"><span>35</span><span>50</span><span>85</span><span>∞</span></div><div className="lens-glass"><span /><i /><i /><i /></div><div className="lens-spec"><b>JOSHUA</b><span>f / 1.4</span></div><small>click to enter<br /><b>the archive</b></small></button>
